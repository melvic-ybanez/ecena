...
data['world']['objects'].append(left_sphere)

for i in range(0, 5):
    component_scale = 0.5 + 0.1 * i
    pattern = {"type": "gradient", "components": [[1, 0.8, 0.1], [220.0 / 255.0, 20.0 / 255.0, 60.0 / 255.0]]}
    ...
    data['world']['objects'].append(small_sphere)
